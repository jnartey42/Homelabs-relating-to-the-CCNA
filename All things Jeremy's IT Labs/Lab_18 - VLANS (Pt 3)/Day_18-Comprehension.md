...
Lab: Given four VLANs, do changes similar to labs done before based on material already learned, such as Router on a Stick, configuring a default route, configuring Switch Virtual Interfaces on SW2, and testing inter-VLAN connectivityy.
